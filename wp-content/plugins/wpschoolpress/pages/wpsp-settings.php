                                ...
                                <div class="wpsp-tabBody wpsp-resp-tabs-container">
                                    ...
                                    <div class="wpsp-tabMain">
                                            ...
                                            <div class="wpsp-col-lg-12 wpsp-col-md-12 wpsp-col-sm-4 wpsp-col-xs-12">
                                                <div class="wpsp-form-group mes-dedeactivate-block">
                                                  <?php
                                                      if(isset($item['onlinepay'])){
                                                           $pl = esc_html($item['onlinepay'],"WPSchoolPress");
                                                      }else{
                                                          $pl = esc_html("Online Fee Payment Addons :","WPSchoolPress");
                                                      }
                                                 ?>

                                                    <label class="wpsp-label"><?php echo $pl; ?></label>

                                                    <input type="text" name="onlinepay"  class="wpsp-form-control" value="<?php echo isset( $settings_data['onlinepay'] ) ? $settings_data['onlinepay'] : '';?>">
